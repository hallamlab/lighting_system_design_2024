...
supp21ab <- plot_grid(supp21a, supp21b,
                                     ncol = 2, 
                                     labels = c("A", "B"),
                                     label_size = 14)

supp21cd <- plot_grid(supp21c, supp21d,
                                     ncol = 2, 
                                     labels = c("C", "D"),
                                     label_size = 14)

supp21 <- plot_grid(supp21ab, supp21cd,
          ncol = 1, 
          labels = c("", ""),
          label_size = 14)
supp21
